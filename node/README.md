...
- **Pre-GA**: v0.9.0-rc6 is a **preview** release (`STABILITY_LEVEL = "preview"`). See [`docs/VERSIONING.md`](docs/VERSIONING.md). SLA: none. Production use: at your own risk. rc6 npm publish is pending productization-ops/sprint_011 T-011-10 (Giri-approval required); the currently *published* preview on npm is **rc5**.
